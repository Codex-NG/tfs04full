...
void Player::addSkillAdvance(skills_t skill, uint64_t count, bool useMultiplier/* = true*/)
{
	...
	//update percent
	uint64_t newPercent = Player::getPercentLevel(skills[skill][SKILL_TRIES], nextReqTries);
...
void Player::addManaSpent(uint64_t amount, bool useMultiplier/* = true*/)
{
	...
	uint64_t newPercent = Player::getPercentLevel(manaSpent, nextReqMana);
...
{
	uint64_t old_level = skills[skill][SKILL_LEVEL];
	std::stringstream s;
